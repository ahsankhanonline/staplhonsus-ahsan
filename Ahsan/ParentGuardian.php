...
<div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="http://localhost/Ahsan/Pupil.php">Pupil</a>
                    <a href="http://localhost/Ahsan/ParentGuardian.php">Parent/Guardian</a>
...
<h3>See all parents/guardians</h3>
		<table>
			<tr>
				<th width="250px">Parent/Guardian ID<br><hr></th>
				<th width="250px">Parent/Guardian name<br><hr></th>
				<th width="250px">Parent/Guardian address<br><hr></th>
				<th width="250px">Parent/Guardian email<br><hr></th>
                <th width="250px">Parent/Guardian phone<br><hr></th>
                <th width="250px">Pupil ID<br><hr></th>
			</tr>
			<?php
			 $sql = mysqli_query($link, "SELECT parentID,parentname,parentaddress,parentemail,parentphone,studentid FROM parents");
